ALTER TABLE PURCHASE_ORDER ADD COLUMN PURCHASE_ORDER_STATUS INTEGER;
ALTER TABLE PURCHASE_ORDER ADD COLUMN PURCHASE_ORDER_STATUS INTEGER;

UPDATE PURCHASE_ORDER SET PURCHASE_ORDER_STATUS=0;
ALTER TABLE PURCHASE_ORDER ALTER COLUMN PURCHASE_ORDER_STATUS SET NOT NULL;
