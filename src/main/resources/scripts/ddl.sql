...
CREATE TABLE  PURCHASE_ORDER(
	...
	PO_INCO_TERM_DESCRIPTION VARCHAR(255),
	PO_DELIVERY_DATE TIMESTAMP,
	PO_DELIVERY_DATE_DESCRIPTION VARCHAR(255),
	RESPONSIBLE_EXPEDITING VARCHAR (100),
	INTRO_EMAIL_SENT TIMESTAMP,
	INTRO_EMAIL_SENT_DESCRIPTION VARCHAR(255),
	REQUIRED_DATE TIMESTAMP,
	REQUIRED_DATE_DESCRIPTION VARCHAR(255),
	ACTUAL_DATE TIMESTAMP,
	ACTUAL_DATE_DESCRIPTION VARCHAR(255),
	LAST_UPDATE TIMESTAMP NOT NULL,
	STATUS_ID INTEGER NOT NULL
);
...
CREATE TABLE SCOPE_SUPPLY(
	...
	EX_WORK_DATE_DESCRIPTION VARCHAR (255),
	DELIVERY_LEAD_TIME_QT INTEGER,
	DELIVERY_LEAD_TIME_MS INTEGER,
	DELIVERY_LEAD_TIME_DESCRIPTION VARCHAR (255),
	SITE_DATE TIMESTAMP,
	SITE_DATE_DESCRIPTION VARCHAR(255),
	PURCHASE_ORDER_ID BIGINT NOT NULL,
	LAST_UPDATE TIMESTAMP NOT NULL,
	STATUS_ID INTEGER NOT NULL,
  ...
  REQUIRED_SITE_DATE TIMESTAMP NOT NULL,
  DELIVERY_DATE_OBS VARCHAR(50),
  ACTUAL_EX_WORK_DATE_OBS VARCHAR(50),
  REQUIRED_SITE_DATE_OBS VARCHAR (50),
  ACTUAL_SITE_DATE_OBS VARCHAR (50),
  IS_FORECAST_SITE_DATE_CALCULATED BOOLEAN NOT NULL
);
...
CREATE TABLE SUPPLIER(
	...
	CONTACT_NAME_DESCRIPTION VARCHAR(255),
	PURCHASE_ORDER_ID BIGINT NOT NULL,
	LAST_UPDATE TIMESTAMP NOT NULL,
	STATUS_ID INTEGER NOT NULL
);
