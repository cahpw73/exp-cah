...
@Named
@ViewScoped
public class ProjectDocumentBean extends Bean implements Serializable {

    public static final Logger log = Logger.getLogger(ProjectDocumentBean.class.getName());
